...
const I = {
  ...
  users: '<svg viewBox="0 0 24 24"><path d="M8.5 11a3.4 3.4 0 1 0 0-6.8 3.4 3.4 0 0 0 0 6.8zm7.5.4a2.9 2.9 0 1 0 0-5.8 2.9 2.9 0 0 0 0 5.8zM2 19.4C2 15.9 4.9 13 8.5 13s6.5 2.9 6.5 6.4zm14.4-4.9c3 .3 5.6 2.5 5.6 4.9h-5.1c0-1.8-.6-3.5-1.6-4.8z"/></svg>',
