...
const I = {
  ...
  carrinho: '<svg viewBox="0 0 24 24"><path d="M1.8 3h2.9a1.4 1.4 0 0 1 1.4 1.2l.2 1.4h14.3a1.4 1.4 0 0 1 1.4 1.7l-1.3 6.2a2.2 2.2 0 0 1-2.2 1.8H8.5a2.2 2.2 0 0 1-2.2-1.9L4.6 5.4a.4.4 0 0 0-.4-.4H1.8zM9 17.8a2 2 0 1 1 0 4 2 2 0 0 1 0-4zM17.6 17.8a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"/></svg>',
  jogos: '<svg viewBox="0 0 24 24"><path d="M7.6 6.4h8.8a5.6 5.6 0 0 1 5.5 4.6l.9 4.9a2.8 2.8 0 0 1-5.2 1.9l-1.2-2.1H7.6l-1.2 2.1a2.8 2.8 0 0 1-5.2-1.9l.9-4.9a5.6 5.6 0 0 1 5.5-4.6zm-1.2 3v1.8H4.6v1.8h1.8v1.8h1.8v-1.8H10v-1.8H8.2V9.4zm9.5.6a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4zm2.6 2.6a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4z"/></svg>',
...
const O = {
  ...
  carrinho: `<path d="M2.4 3.6h2.3a1.2 1.2 0 0 1 1.2 1l1.6 9.2a2 2 0 0 0 2 1.7h9.3a2 2 0 0 0 2-1.6l1.2-5.7a1.2 1.2 0 0 0-1.2-1.4H6.3"/><circle cx="9.4" cy="19.4" r="1.7"/><circle cx="17.8" cy="19.4" r="1.7"/>`,
  jogos: `<path d="M7.8 7.2h8.4a5 5 0 0 1 4.9 4.1l.8 4.4a2.4 2.4 0 0 1-4.5 1.6l-1.1-2H7.7l-1.1 2a2.4 2.4 0 0 1-4.5-1.6l.8-4.4a5 5 0 0 1 4.9-4.1z"/><path d="M7.3 10.4v3.2M5.7 12h3.2"/><path d="M15.7 11.2h.01M17.9 13.4h.01"/>`,
  ...
  sair: `<path d="M9.6 20.4H5.4a1.8 1.8 0 0 1-1.8-1.8V5.4a1.8 1.8 0 0 1 1.8-1.8h4.2"/><path d="M15.6 16.2l4.2-4.2-4.2-4.2M19.8 12H9.6"/>`,
...
/* O acento do documento é a cor de marca. Cada tela ainda chama `setAccent` no
   próprio elemento — com a cor do treino, quando é o caso —, mas o que não
   pertence a treino nenhum herda daqui. */
function aplicarEsquema() {
  setAccent(corMarca());
}

/* Cor dos detalhes fora do treino. Era o branco do tema, para a cor colorida
   significar sempre "isto pertence a um treino". Agora é a cor de marca: o app
   tem uma cor, e o que identifica um treino é ele ter uma **própria**, diferente
   dela — o contraste continua existindo, só deixou de ser branco contra colorido
   para ser marca contra a cor do treino. */
...
/* A cor de um item novo é a cor do app, que não está na paleta das doze. Ela
   entra na lista com o próprio nome em vez de aparecer como "Cor própria" — o
